...
const CandidateRegistration = () => {
    ...
    const { uploadToIPFSCandidate, setCandidate, getNewCandidate, currentAccount, votingOrganizer, checkIfWalletIsConnected } = useContext(VotingContext);
                ...
                {!isAuthorized ? (
                    <div className="w-full text-center py-20 flex flex-col items-center">
                        ...
                        <p className="text-gray-400 text-lg max-w-lg mx-auto mb-8">
                            {!currentAccount 
                                ? "Please connect your MetaMask wallet. This is the Candidate Registration Dashboard."
                                : "This is the Candidate Registration Dashboard. Only the Election Organizer (Admin) is authorized to access this page."}
                        </p>
