...
const AllowedVoters = () => {
    ...
    const { uploadToIPFS, createVoter, currentAccount, votingOrganizer } = useContext(VotingContext);
                ...
                {currentAccount && votingOrganizer && currentAccount.toLowerCase() !== votingOrganizer.toLowerCase() ? (
                    <div className="w-full text-center py-20 flex flex-col items-center">
                        ...
                        <p className="text-gray-400 text-lg max-w-lg mx-auto mb-8">
                            This is the Voter Registration Dashboard. Only the Election Organizer (Admin) is authorized to access this page and authorize voters to participate.
                        </p>
